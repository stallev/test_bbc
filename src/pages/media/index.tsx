...
export default function Media({ pageData }: any) {
  return (
    <>
      <Head>
      ...
      <div className={styles.media}>
        <Container isMarkdownContent={true}>
          <Text textType="h1" className={styles.media__title}>
            {pageData.title}
          </Text>

          <StructuredMarkdownContent
            content={pageData.pageContent}
            className={styles["media__page-content"]}
          />
        </Container>
      </div>
    </>
...
export async function getStaticProps({ locale }: any) {
  const pageId = locale == "en" ? PagesIDs.MediaPage.en : PagesIDs.MediaPage.ru;
