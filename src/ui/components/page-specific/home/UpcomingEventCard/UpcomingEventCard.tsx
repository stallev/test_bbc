...
const UpcomingEventCard = ({ data }: { data: UpcomingEventCardItemProps }) => {
  ...
  return (
    <article className={styles['upcoming-event-card']}>
      <Text
        textType='span'
        className={styles['upcoming-event-card__start-date']}
      >
      ...
      <Text
        textType='h3'
        className={styles['upcoming-event-card__title']}
      >
        {data.title}
      </Text>
      ...
      <Text
        textType='p'
        className={styles['upcoming-event-card__description']}
      >
