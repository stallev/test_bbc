...
const PrayerRequest = ({ translations }: PrayerRequestProps) => {
  ...
  return (
    <div className={styles["prayer-request"]}>
      <Text textType='p' className={styles["prayer-request__goal-text"]}>{translations.prayer_text_goal}</Text>
      <Text textType='h1' className={styles["prayer-request__title"]}>{translations.prayer_title}</Text>
      ...
      <div className={styles["prayer-request__action"]}>
        <Text textType='p' className={styles["prayer-request__motivation"]}>{translations.prayer_motivation}</Text>
