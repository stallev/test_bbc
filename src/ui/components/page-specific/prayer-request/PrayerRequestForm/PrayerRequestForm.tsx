...
import { PrayerRequestEndpoint, NotificationTypes } from '@/constants';
...
import styles from './styles/prayer-request-form.module.scss';
...
const PrayerRequestForm:React.FC = () => {
  ...
  return (
    <div>
      <form
        className={styles["prayer-request-form"]}
        onSubmit={handleSubmit(onSubmit)}
      >
        <CustomInput
          type={InputTypes.text}
          placeholder={translate(FormFieldLangCodes.firstName)}
          className={styles['prayer-request-form__input-field']}
        ...
        <Checkbox
          ...
          className={styles["prayer-request-form__is-willing-to-be-contacted"]}
...

        {
          ...
          <CustomInput
            ...
            // validate={register("phone", { pattern: /^\+\d{12}$/ })}
          />
        }
        ...
        <CustomTextarea
          className={styles['prayer-request-form__textarea-field']}
        ...
        <Button
          className={styles['prayer-request-form__submit']}
          buttonTitle={translate("share_prayer_request")}
          type='primary'
          isSubmit={true}
        />
      </form>
