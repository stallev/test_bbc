...
const MinistryDescription = ({
  ...
  return (
    <div className={styles['ministry-description']}>
      <Text textType="h3" className={styles['ministry-description__title']}>
      ...
      <div className={styles['ministry-description__content']}>
        <div className={styles['ministry-description__active-time']}>
          <Text textType="span" className={styles['ministry-description__active-days']}>
            {ministryDays}
          </Text>

          <Text textType="span" className={styles['ministry-description__active-hours']}>
            {ministryHours}
          </Text>
        </div>
