...
const StructuredMarkdownContent: React.FC<StructuredMarkdownContentProps> = ({
  ...
  const [currentBlocksFontSizes, setCurrentBlocksFontSizes] = useState(
            ...
            case GutenbergBlocksTypes.paragraph:
              return (
                <Text
                  ...
                  fontSize={
                    isFontSizeResizable
                      ? currentBlocksFontSizes && currentBlocksFontSizes.p
                      : null
                  }
                >
            ...
            case GutenbergBlocksTypes.image:
              return (
                <CustomImage
                  key={block.order}
                  className={
                    styles["structured-markdown-content__single-image-wrap"]
                  }
                  sizes="80vw"
                  alt=""
              ...
              return (
                <Blockquote
                  ...
                  fontSize={
                    isFontSizeResizable
                      ? currentBlocksFontSizes &&
                        currentBlocksFontSizes.blockquote
                      : null
                  }
